...
const PaymentGatewayVisual = () => {
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-4 sm:p-5 flex items-center justify-between overflow-hidden group-hover:scale-105 transition-transform duration-700 select-none">
      {/* Ambient Lighting */}
      ...
      <div className="relative z-10 w-[46%] h-full bg-slate-900 border border-slate-700/80 rounded-xl p-2.5 flex flex-col justify-between shadow-xl shadow-slate-950/60 transform -rotate-1 group-hover:rotate-0 transition-transform duration-500">
        <div className="flex items-center justify-between border-b border-slate-800 pb-1.5 mb-1 text-[9px]">
          <span className="font-bold text-purple-300 flex items-center gap-1">
            <FontAwesomeIcon icon={faCreditCard} className="text-purple-400" /> Xmoney Checkout
          </span>
          <span className="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-bold text-[8px] border border-emerald-500/30 flex items-center gap-0.5">
            <FontAwesomeIcon icon={faShieldHalved} className="text-[7px]" /> Encrypted
          </span>
        </div>

        {/* Card Mockup Graphic */}
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-sky-600 rounded-lg p-2 text-white shadow-md my-1">
      ...
      {/* Right: Payment API Inspection Terminal */}
      <div className="relative z-10 w-[50%] h-full bg-slate-950/90 border border-slate-800 rounded-xl p-2.5 flex flex-col justify-between shadow-2xl font-mono text-[9px] transform rotate-1 group-hover:rotate-0 transition-transform duration-500">
        <div className="flex items-center justify-between border-b border-slate-800/80 pb-1.5 mb-1.5">
          <span className="text-[9px] font-bold text-slate-200">Xmoney Payment Gateway API</span>
          <span className="text-[8px] font-bold px-1.5 py-0.5 rounded bg-purple-500/20 text-purple-300 border border-purple-500/30">
            v1.2 Active
          </span>
        </div>
        ...
        <div className="space-y-1 font-mono text-[8px] leading-tight text-slate-300">
          <div className="flex items-center justify-between bg-slate-900/90 p-1 rounded border border-slate-800">
            <span className="text-purple-400 font-bold">POST /xmoney/payment/charge</span>
        ...
        <div className="flex items-center justify-between pt-1 border-t border-slate-800/80 text-[8px] text-slate-400">
          ...
          <span className="text-purple-300 font-bold">Instant Callback</span>
        </div>
      </div>
    </div>
  );
